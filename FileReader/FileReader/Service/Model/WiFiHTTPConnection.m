...
@implementation WiFiHTTPConnection
...
//        NSDirectoryEnumerator *direnum = [[NSFileManager defaultManager] enumeratorAtPath:[paths objectAtIndex:0]];
        ...
        //展示所有文件
//        NSDirectoryEnumerator *direnum = [[NSFileManager defaultManager] enumeratorAtPath: DoucmentPath];
...
//    NSString *uploadFilePath = [[paths objectAtIndex:0] stringByAppendingPathComponent:fileName];
    ...
    NSString *uploadFilePath = [DoucmentPath stringByAppendingPathComponent:fileName];
