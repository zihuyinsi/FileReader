...
//    //判断是否分章成功
//    NSMutableDictionary *chapterDict = [UserDefaults objectForKey: ChapterOK];
//    if (![chapterDict isEqual: [NSNull null]] && chapterDict != nil)
//    {
//        NSMutableDictionary *ChapterInfo = chapterDict[_chapterName];
//        if (![ChapterInfo isEqual: [NSNull null]] && ChapterInfo != nil)
//        {
//            NSInteger chapterNum = [ChapterInfo[ChapterTotal] integerValue];
//            _totalChapter = chapterNum;
//            [self chapterOk];
//        }
//        else
//        {
